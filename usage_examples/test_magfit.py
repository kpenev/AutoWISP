...
#    fit_dir = '/data/HAT10DSLR_sandbox/FITPSF_short'
    ...
    magnitude_fitting.iterative_refit(
        ...
        master_photref_fname_pattern=(
            '/data/HAT10DSLR_sandbox/MASTERS/'
