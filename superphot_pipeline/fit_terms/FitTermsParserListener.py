...
class FitTermsParserListener(ParseTreeListener):
    ...
    def enterFit_terms_set_cross_product(self, ctx:FitTermsParser.Fit_terms_set_cross_productContext):
        pass

    # Exit a parse tree produced by FitTermsParser#fit_terms_set_cross_product.
    def exitFit_terms_set_cross_product(self, ctx:FitTermsParser.Fit_terms_set_cross_productContext):
        pass


    # Enter a parse tree produced by FitTermsParser#fit_terms_expression.
    def enterFit_terms_expression(self, ctx:FitTermsParser.Fit_terms_expressionContext):
        pass

    # Exit a parse tree produced by FitTermsParser#fit_terms_expression.
    def exitFit_terms_expression(self, ctx:FitTermsParser.Fit_terms_expressionContext):
        pass
