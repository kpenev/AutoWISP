...
class FitTermsParserVisitor(ParseTreeVisitor):
    ...
    def visitFit_terms_set_cross_product(self, ctx:FitTermsParser.Fit_terms_set_cross_productContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FitTermsParser#fit_terms_expression.
    def visitFit_terms_expression(self, ctx:FitTermsParser.Fit_terms_expressionContext):
        return self.visitChildren(ctx)
